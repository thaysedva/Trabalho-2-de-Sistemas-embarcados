...
<html>
  ...
  <body>
    ...
    <div class="content">
      <div class="card">
        <h2>Output - GPIO</h2>
        <p class="state">State Led 1: <span id="state1">%STATE1%</span></p>
        <p><button id="button1" class="button">Toggle</button></p>
        <p class="state">State Led 2: <span id="state2">%STATE2%</span></p>
    ...
    <script>
      ...
      function onMessage(event)
      {
        ...
        var state1;
        var state2;
        if (event.data == "10" || event.data == "11")
        {
          state1 = "ON";
        }
        else
        ...
        if (event.data == "01" || event.data == "11")
        {
          state2 = "ON";
        }
        else
